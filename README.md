...
Automated testing is also performed on the latest version of GNU/Linux using GitHub Actions.


## Pre-built Executables

Framework-dependent executables are available for macOS (ARM64), GNU/Linux (x86_64), and Windows (x86_64). You can download the latest version from the [Releases](../../releases) page.

**Note:** The [framework-dependent executables](https://learn.microsoft.com/en-us/dotnet/core/deploying/deploy-with-cli) require the .NET 8.0 runtime (or later). You can download it from the [.NET website](https://dotnet.microsoft.com/en-us/download/dotnet/8.0/runtime) (`brew install --cask dotnet` on macOS). Alternatively, you can download the [full SDK](https://dotnet.microsoft.com/en-us/download) (`brew install --cask dotnet-sdk` on macOS) to build the project from source.
